...
# ステップ1: 前提条件チェック
echo -e "${YELLOW}[1/14] 前提条件チェック...${NC}"
...
echo ""
echo -e "${YELLOW}[2/14] プロジェクト初期化...${NC}"
...
# ステップ3: シンボリックリンク作成
echo ""
echo -e "${YELLOW}[3/14] Taisun Agent シンボリックリンク作成...${NC}"
...
echo ""
echo -e "${YELLOW}[4/14] CC-Company統合スキルの注入...${NC}"
...
echo ""
echo -e "${YELLOW}[5/14] Playwright Skill の注入...${NC}"
...
echo ""
echo -e "${YELLOW}[6/14] プロンプトブースター & ブリーフィング を秘書に注入...${NC}"
...
echo ""
echo -e "${YELLOW}[7/14] Interactive Video Platform の注入...${NC}"
...
echo ""
echo -e "${YELLOW}[8/14] Mission Skill の注入...${NC}"
...
echo ""
echo -e "${YELLOW}[9/14] Briefing Skill の注入...${NC}"
...
echo ""
echo -e "${YELLOW}[10/14] ECC統合 (everything-claude-code) セットアップ...${NC}"
...
echo ""
echo -e "${YELLOW}[11/14] Anthropic公式プラグイン注入...${NC}"
...
echo ""
echo -e "${YELLOW}[12/14] Skill Generator 注入...${NC}"
...
echo ""
echo -e "${YELLOW}[13/14] n8n MCP サーバー設定確認...${NC}"
