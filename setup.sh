...
# ステップ1: 前提条件チェック
echo -e "${YELLOW}[1/15] 前提条件チェック...${NC}"
...
echo ""
echo -e "${YELLOW}[2/15] プロジェクト初期化...${NC}"
...
# ステップ3: シンボリックリンク作成
echo ""
echo -e "${YELLOW}[3/15] Taisun Agent シンボリックリンク作成...${NC}"
...
echo ""
echo -e "${YELLOW}[4/15] CC-Company統合スキルの注入...${NC}"
...
echo ""
echo -e "${YELLOW}[5/15] Playwright Skill の注入...${NC}"
...
echo ""
echo -e "${YELLOW}[6/15] プロンプトブースター & ブリーフィング を秘書に注入...${NC}"
...
echo ""
echo -e "${YELLOW}[7/15] Interactive Video Platform の注入...${NC}"
...
echo ""
echo -e "${YELLOW}[8/15] Mission Skill の注入...${NC}"
...
echo ""
echo -e "${YELLOW}[9/15] Briefing Skill の注入...${NC}"
...
echo ""
echo -e "${YELLOW}[10/15] ECC統合 (everything-claude-code) セットアップ...${NC}"
...
echo ""
echo -e "${YELLOW}[11/15] Anthropic公式プラグイン注入...${NC}"
...
echo ""
echo -e "${YELLOW}[12/15] Anthropic公式スキル注入...${NC}"
...
echo ""
echo -e "${YELLOW}[13/15] Skill Generator 注入...${NC}"
...
echo ""
echo -e "${YELLOW}[14/15] n8n MCP サーバー設定確認...${NC}"
